...
--
-- Name: accounts_bankaccount; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.accounts_bankaccount (
    id bigint NOT NULL,
    ...
    rib_key character varying(10) NOT NULL,
    bic_swift character varying(20) NOT NULL,
...
ALTER TABLE public.accounts_bankaccount OWNER TO postgres;

--
-- Name: accounts_bankaccount_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.accounts_bankaccount ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.accounts_bankaccount_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: accounts_businessdetail; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.accounts_businessdetail (
    id bigint NOT NULL,
    company_name character varying(255) NOT NULL,
    siret_number character varying(50) NOT NULL,
    full_address text NOT NULL,
    type_of_activity character varying(255) NOT NULL,
    service_area character varying(255) NOT NULL,
    siret_verified boolean NOT NULL,
    user_id bigint NOT NULL
);


ALTER TABLE public.accounts_businessdetail OWNER TO postgres;

--
-- Name: accounts_businessdetail_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.accounts_businessdetail ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.accounts_businessdetail_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: bussiness_documents_document; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.bussiness_documents_document (
    id bigint NOT NULL,
...
ALTER TABLE public.bussiness_documents_document OWNER TO postgres;

--
-- Name: bussiness_documents_document_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.bussiness_documents_document ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.bussiness_documents_document_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: accounts_bankaccount accounts_bankaccount_bic_swift_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.accounts_bankaccount
    ADD CONSTRAINT accounts_bankaccount_bic_swift_key UNIQUE (bic_swift);


--
-- Name: accounts_bankaccount accounts_bankaccount_iban_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.accounts_bankaccount
    ADD CONSTRAINT accounts_bankaccount_iban_key UNIQUE (iban);


--
-- Name: accounts_bankaccount accounts_bankaccount_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.accounts_bankaccount
    ADD CONSTRAINT accounts_bankaccount_pkey PRIMARY KEY (id);


--
-- Name: accounts_bankaccount accounts_bankaccount_rib_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.accounts_bankaccount
    ADD CONSTRAINT accounts_bankaccount_rib_key_key UNIQUE (rib_key);


--
-- Name: accounts_bankaccount accounts_bankaccount_user_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.accounts_bankaccount
    ADD CONSTRAINT accounts_bankaccount_user_id_key UNIQUE (user_id);


--
-- Name: accounts_businessdetail accounts_businessdetail_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.accounts_businessdetail
    ADD CONSTRAINT accounts_businessdetail_pkey PRIMARY KEY (id);


--
-- Name: accounts_businessdetail accounts_businessdetail_user_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.accounts_businessdetail
    ADD CONSTRAINT accounts_businessdetail_user_id_key UNIQUE (user_id);
...
--
-- Name: bussiness_documents_document bussiness_documents_document_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bussiness_documents_document
    ADD CONSTRAINT bussiness_documents_document_pkey PRIMARY KEY (id);
...
--
-- Name: accounts_bankaccount_bic_swift_586c9bc1_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX accounts_bankaccount_bic_swift_586c9bc1_like ON public.accounts_bankaccount USING btree (bic_swift varchar_pattern_ops);


--
-- Name: accounts_bankaccount_iban_51c1cc6d_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX accounts_bankaccount_iban_51c1cc6d_like ON public.accounts_bankaccount USING btree (iban varchar_pattern_ops);


--
-- Name: accounts_bankaccount_rib_key_cbfc388e_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX accounts_bankaccount_rib_key_cbfc388e_like ON public.accounts_bankaccount USING btree (rib_key varchar_pattern_ops);
...
--
-- Name: bussiness_documents_document_user_id_2417ea66; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX bussiness_documents_document_user_id_2417ea66 ON public.bussiness_documents_document USING btree (user_id);
...
--
-- Name: accounts_bankaccount accounts_bankaccount_user_id_a50ca531_fk_accounts_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.accounts_bankaccount
    ADD CONSTRAINT accounts_bankaccount_user_id_a50ca531_fk_accounts_user_id FOREIGN KEY (user_id) REFERENCES public.accounts_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: accounts_businessdetail accounts_businessdetail_user_id_77ff5736_fk_accounts_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.accounts_businessdetail
    ADD CONSTRAINT accounts_businessdetail_user_id_77ff5736_fk_accounts_user_id FOREIGN KEY (user_id) REFERENCES public.accounts_user(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: bussiness_documents_document bussiness_documents__user_id_2417ea66_fk_accounts_; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.bussiness_documents_document
    ADD CONSTRAINT bussiness_documents__user_id_2417ea66_fk_accounts_ FOREIGN KEY (user_id) REFERENCES public.accounts_user(id) DEFERRABLE INITIALLY DEFERRED;
