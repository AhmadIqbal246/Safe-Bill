...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#01257D] text-[#96C2DB] pt-12 pb-6 px-4 border-t border-[#01257D] overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:flex-wrap md:justify-between gap-10 md:gap-4">
        {/* Columns */}
      ...
      {/* Contact and Socials */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:flex-wrap md:justify-between items-center mt-8 gap-4 md:gap-4 border-t border-[#E6F0FA] pt-6">
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 mb-2 md:mb-0">
          <a href={`mailto:${Email}`} className="flex items-center gap-2 text-white overflow-wrap-anywhere">
