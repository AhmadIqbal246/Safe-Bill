...
export default function MyProfileComp() {
  ...
  useEffect(() => {
    if (selectedRating && !isFeedbackEdited) {
      const feedbackMessages = {
        Excellent: t('my_profile.feedback_excellent'),
        Good: t('my_profile.feedback_good'),
        "Needs Improvement": t('my_profile.feedback_needs_improvement'),
      };
      setFeedbackText(feedbackMessages[selectedRating] || "");
    }
  }, [t, selectedRating, isFeedbackEdited]);
      ...
      <div className="max-w-2xl mx-auto relative z-10 py-8 px-4">
        ...
        <div className="mb-8">
          ...
          <div className="flex gap-2 mb-4 flex-wrap">
            {[
              { key: "Excellent", label: t('my_profile.rating_excellent') },
              { key: "Good", label: t('my_profile.rating_good') },
              { key: "Needs Improvement", label: t('my_profile.rating_needs_improvement') }
            ].map(({ key, label }) => (
              <button
                key={key}
                className={`px-4 py-2 rounded-md border font-semibold text-sm transition-colors bg-white text-gray-700 border-gray-200 hover:bg-[#E6F0FA] cursor-pointer ${selectedRating === key
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <ChevronDown
                          className={`h-4 w-4 text-gray-400 transition-transform ${showBusinessActivityDropdown ? "rotate-180" : ""
                            }`}
                        />
                      </button>
                            ...
                            {businessActivityStructure
                              ...
                              .map((option) => (
                                <button
                                  key={option.id}
                                  type="button"
                                  className={`w-full px-4 py-2 text-left hover:bg-[#F0F4F8] transition-colors ${editForm.type_of_activity === option.id
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          ...
                          <ChevronDown
                            className={`h-4 w-4 text-gray-400 transition-transform ${showCategoriesDropdown ? "rotate-180" : ""
                              }`}
                          />
                        </button>
                                ...
                                return categories
                                  ...
                                  .map((option) => (
                                    <button
                                      key={option.id}
                                      type="button"
                                      className={`w-full px-4 py-2 text-left hover:bg-[#F0F4F8] transition-colors ${editForm.selected_categories?.includes(option.id)
                                        ? "bg-[#E6F0FA] text-[#01257D] font-semibold"
                                        : "text-gray-700"
                                        }`}
                                      onClick={() => {
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          ...
                          <ChevronDown
                            className={`h-4 w-4 text-gray-400 transition-transform ${showSubcategoriesDropdown ? "rotate-180" : ""
                              }`}
                          />
                        </button>
                                ...
                                return allSubcategories
                                  ...
                                  .map((option) => (
                                    <button
                                      key={option.id}
                                      type="button"
                                      className={`w-full px-4 py-2 text-left hover:bg-[#F0F4F8] transition-colors ${editForm.selected_subcategories?.includes(option.id)
                                        ? "bg-[#E6F0FA] text-[#01257D] font-semibold"
                                        : "text-gray-700"
                                        }`}
                                      onClick={() => {
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <ChevronDown
                          className={`h-4 w-4 text-gray-400 transition-transform ${showServiceAreasDropdown ? "rotate-180" : ""
                            }`}
                        />
                      </button>
                            ...
                            {serviceAreaOptions
                              ...
                              .map((option) => (
                                <button
                                  key={option.value}
                                  type="button"
                                  className={`w-full px-4 py-2 text-left hover:bg-[#F0F4F8] transition-colors ${editForm.selected_service_areas?.includes(option.value)
                                    ? "bg-[#E6F0FA] text-[#01257D] font-semibold"
                                    : "text-gray-700"
                                    }`}
                                  onClick={() => {
