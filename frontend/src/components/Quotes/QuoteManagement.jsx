                  ...
                  {filteredProjects.map((p, i) => (
                    <tr key={p.id} className="border-t border-gray-100">
                      ...
                      <td className="px-4 py-3 whitespace-nowrap flex gap-2 items-center">
                        ...
                        {p.status === 'approved' && (
                          <button
                            className={`p-1 hover:bg-gray-100 rounded cursor-pointer ${startingProjectId === p.id ? 'opacity-50 cursor-not-allowed' : ''
                              }`}
                        ...
                        {p.status === 'in_progress' && (
                          <button
                            className={`p-1 hover:bg-gray-100 rounded cursor-pointer ${completingProjectId === p.id ? 'opacity-50 cursor-not-allowed' : ''
                              }`}
