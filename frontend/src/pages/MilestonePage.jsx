...
export default function MilestonePage() {
  ...
  // Display status in current language
  const getDisplayStatus = (status) => {
    const statusMap = {
      'not_submitted': 'milestones.status_not_submitted',
      'pending': 'milestones.status_pending',
      'approved': 'milestones.status_approved',
      'review_request': 'milestones.status_review_request',
      'not_approved': 'milestones.status_not_approved',
    };
    return statusMap[status] ? t(statusMap[status]) : capitalizeStatus(status);
  };
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-2">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className={`p-2 rounded-md transition-colors ${canEditMilestone(milestone)
                  ...
                  <form onSubmit={handleEditSubmit} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        value={getDisplayMilestoneName(editForm.name)}
                        readOnly
                        disabled
                      />
                    </div>
